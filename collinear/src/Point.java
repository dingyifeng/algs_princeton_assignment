...
public class Point implements Comparable<Point> {
     ...
     *         argument point
     */
    public int compareTo(Point that) { // when use Array.sort() to sort the Point[], this method define the
    ...
    /* public Comparator<Point> slopeOrder() {
     ...
     /*   return new Comparator<Point>() {
            // the interface of compare is int compare(Object obj1,Object obj2)
    ...
    private class pointComparator implements Comparator<Point> {
        @Override
        public int compare(Point point1, Point point2) {
            double pointSlope1 = slopeTo(point1);
            double pointSlope2 = slopeTo(point2);
            return Double.compare(pointSlope1,pointSlope2);
        }
    }
